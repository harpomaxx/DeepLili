...
with gr.Blocks() as demo:
    ...
    ## 3. Descubrí: Observá cómo la IA crea una imagen inspirada en la serie Toy Art de Lili Fiallo.
    ...
    gr.HTML(
    """
    <h6><a href="https://harpomaxx.github.io/">Fine tuned by Harpo MAxx </a></h6>
    """
    )
